                            ...
                            <div>
                                ...
                                <div className="flex gap-2 mt-2 items-center h-11 justify-center">
                                    <Link
                                        ...
                                        className="p-2 w-40 text-black text-center dark:text-white hover:font-bold rounded-full 
                                    hover:dark:border-white border-2 hover:border-black border-gray-500 focus:border-gray-800 duration-150 ease-out focus:outline-none"
                                    >
                                        View Post
                                    </Link>
                                    <Link
